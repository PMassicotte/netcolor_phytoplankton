...
The following table shows the HPLC data that have no metadata associated.
...
These are measurements without goegraphical coordinates.
...
```{r, fig.align='center'}
knitr::include_graphics(pdf2png(here("graphs/05_geographical_map.pdf")))
```
